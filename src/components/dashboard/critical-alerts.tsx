...
export function CriticalAlerts({
  ...
  if (abaixoMinimo > 0) {
    alerts.push({
      icon: PackageX,
      title: `${abaixoMinimo} produto${abaixoMinimo !== 1 ? "s" : ""} abaixo do mínimo`,
      description: "Reabasteça antes que afete suas vendas.",
  ...
  if (semEstoque > 0) {
    alerts.push({
      icon: PackageX,
      title: `${semEstoque} produto${semEstoque !== 1 ? "s" : ""} sem estoque`,
      description: "Reponha imediatamente para evitar ruptura.",
      href: "/dashboard/estoque/produtos",
      tone: "danger",
    })
  }
