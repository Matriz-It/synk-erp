...
const KPIS: Kpi[] = [
  { label: "Faturamento do mês", value: "R$ 184.230", delta: "+12,4%", trend: "up", positiveDirection: "up", icon: TrendingUp, caption: "vs. abril · 31 dias úteis" },
  { label: "Inadimplência", value: "R$ 12.480", delta: "+3,1%", trend: "up", positiveDirection: "down", icon: TrendingDown, caption: "8 contas vencidas há +30 dias" },
  { label: "Itens em estoque", value: "2.845", delta: "-58 un.", trend: "down", positiveDirection: "up", icon: PackageSearch, caption: "12 produtos abaixo do mínimo" },
  { label: "Saldo em caixa", value: "R$ 86.910", delta: "+8,2%", trend: "up", positiveDirection: "up", icon: Wallet, caption: "3 contas · projeção positiva" },
]
  ...
  return (
    <article className="flex flex-col gap-3 rounded-lg border border-[#E2E8F0] bg-white p-5 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-[12px] text-[#94A3B8]">{kpi.caption}</span>
      </div>
    </article>
  )
}
